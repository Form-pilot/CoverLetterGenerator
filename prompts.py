...
- Do not include skills from the job description in the tailored resume if they are not already part of the current resume and I lack experience with them.
...
- Ensure all main section titles remain exactly as they appear in the original template, without modification.
...
- Ensure characters which have special meaning in the LaTex should be escaped to appear as part of the text. For example # should be replaced with \#.

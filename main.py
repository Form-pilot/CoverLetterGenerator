...
def generate_tailored_plain_resume(resume: str, job_description: str, model: AIModel = AIModel.gpt_4o_mini, template: int = 1) -> str:
    """
...
def generate_tailored_latex_resume(resume: str, job_description: str, model: AIModel = AIModel.gpt_4o_mini, template: int = 1) -> str:
    """
...
def generate_tailored_latex_resume_save(job_description: str, resume: str = john_doe_resume, model: AIModel = AIModel.gpt_4o_mini, template: int = 1):
    """
